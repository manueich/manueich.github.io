...
We can see that the prior distributions differ quite significantly as a result of the mean-field approximation. However, the posterior results are very similar, showing the utility of the approximation. The iterative maximisation of the Free Energy and approximation to the true log marginal likelihood is shown in the following figure.
